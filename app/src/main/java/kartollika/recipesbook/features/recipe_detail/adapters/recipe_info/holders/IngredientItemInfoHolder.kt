package kartollika.recipesbook.features.recipe_detail.adapters.recipe_info.holders
...
class IngredientItemInfoHolder(view: View) : BaseChipHolder<IngredientDetail>(view) {
